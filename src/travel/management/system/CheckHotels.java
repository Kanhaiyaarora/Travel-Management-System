...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run() {
        String[] text = new String[]{"JW Marriott Hotel","River View Hotel", "Four Seasons Hotel", "Raddisson Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "Snow Point Hotel", "Happy Morning Hotel", "Madarin Oriental Hotel"};
        try {
            for (int i = 0; i <= 9; i++) {
